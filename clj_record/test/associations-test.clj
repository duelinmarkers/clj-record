...
(comment
(deftest find-records-can-do-eager-fetching-of-has-many-association
  (let [manu1 (manufacturer/create {:name "manu1" :grade 99})
    ...
    (manufacturer/destroy-products manu1)
    (manufacturer/destroy-products manu2)
    (manufacturer/destroy-record manu1)
    (manufacturer/destroy-record manu2)))
)