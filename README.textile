...
Run <code>ant</code> to compile source and run tests. By default the tests run with "Apache Derby":http://db.apache.org/derby/ . (You can uncomment and modify a different db-spec in test/clj-record/test_model/config.clj to use MySQL or PostgreSQL.)
